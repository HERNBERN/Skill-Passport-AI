  ...
  head: () => ({
    meta: [
      ...
      { title: "SkillLens AI — AI Skill Passport Platform" },
      {
        name: "description",
        content:
          "Turn learning evidence into a verifiable Digital Skill Passport. Every skill is traced back to its source document, repository or portfolio.",
      },
      { name: "author", content: "SkillLens AI" },
